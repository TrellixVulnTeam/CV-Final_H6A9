...
if __name__ == "__main__":
    ...
    #   'proposal_box'      表示遍历文件夹进行检测并保存rpn输出的proposal box
    #----------------------------------------------------------------------------------------------------------#
    mode = "dir_predict"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                r_image.save(os.path.join(dir_save_path, img[4:-3] + 'png'))
                r_image.show()
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(
                ...
                image = Image.open(image_path)
                r_image = frcnn.get_proposal_box(image)
                if not os.path.exists(os.path.join(dir_save_path, 'proposalbox')):
                    os.makedirs(os.path.join(dir_save_path, 'proposalbox'))
                r_image.save(os.path.join(dir_save_path, 'proposalbox', img_name.replace(".jpg", ".png")), quality=95, subsampling=0)
    else:
